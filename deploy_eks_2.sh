...
# ログイン
argocd login ${ARGOCD_SERVER_DOMAIN} -y --username admin --password ${ARGOCD_PASSWARD}
...
#K8S_CLUSTER_NAME=`argocd cluster add | grep ${CLUSTER_NAME} | awk '{print $1}'`
K8S_CLUSTER_NAME=iam-root-account@${CLUSTER_NAME}.${REGION}.eksctl.io
